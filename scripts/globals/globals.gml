...
global.GAMEPLAY_COURSE_ZONE_WEIGHT = {
	CITY: {
		...
		ZONES: [ZONE.CITY, ZONE.SUBURBAN, ZONE.RIVER],
		WEIGTHS: [200, 25, 10],
		MAX_LANES: 3,
	},
	SUBURBAN: {
		STARTING_ZONE: ZONE.CITY,
		ZONES: [ZONE.CITY, ZONE.FOREST, ZONE.RIVER],
		WEIGTHS: [100, 100, 50],
		MAX_LANES: 2,
	},
	DESERT: {
		STARTING_ZONE: ZONE.DESERT,
		ZONES: [ZONE.CITY, ZONE.DESERT],
		WEIGTHS: [20, 200],
		MAX_LANES: 3,
	},
	MOUNTAIN: {
		STARTING_ZONE: ZONE.SUBURBAN,
		ZONES: [ZONE.FOREST, ZONE.RIVER, ZONE.SUBURBAN, ZONE.CITY],
		WEIGTHS: [200, 30, 20, 10],
		MAX_LANES: 1,
	},
}
