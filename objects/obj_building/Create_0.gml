...
function init_vertex_buffer() {
	...
	image_xscale = building_width / 3;
	image_yscale = building_length / 3;
	image_angle = direction;
	building_height = 128 * floors;
	
	var building_color_side = c_white;
	var building_sprite = spr_building_front_1_floor;
    var building_side_sprite = spr_building_side;
	...
	switch(floors) {
		...
		case 2: 
            ...
            building_side_sprite = building_sprite;
            building_color_side = building_color;
			uv = sprite_get_uvs(building_sprite, display_image_index);
			break;
		default:
			if (floors > 2) {
    ...
    var building_side_uv = sprite_get_uvs(building_side_sprite, 0);
    var points = [];
	// -y
    points = array_concat(
        points, 
